...
class ShapesLogisticOracle(nn.Module):
    """
    ...
    def __init__(self, n_classes, n_attr):
        ...
        """
        super(ShapesLogisticOracle, self).__init__()
        self.name = "ShapesLogisticOracle"
...
class ShapesNNOracle(nn.Module):
    """
    ...
    def __init__(self, n_classes, n_attr):
        ...
        Args:
            ...
            n_attr (int): The amount of input concepts.
        """
        super(ShapesNNOracle, self).__init__()
        self.name = "ShapesNNOracle"
