...
def parse_arguments():
    ...
    parser.add_argument("--alpha", type=float, default=0.000075, help="Step size for perturbation in attacks")
    ...
    parser.add_argument("--max_steps", type=int, default=300, help="Max steps for iterative attacks.")
    parser.add_argument("--max_images", type=int, default=10, help="Max number of images to run attacks on")
...
if __name__ == "__main__":
    ...
    if args.evaluate_and_plot:
        ...
        run_models_on_subsets_and_plot(
            ...
            non_blocking=args.non_blocking, num_workers=args.num_workers,
